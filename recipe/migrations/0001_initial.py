    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('category', models.CharField(choices=[('food', 'Food'), ('drink', 'Drink'), ('other', 'Other')], default='food', max_length=50)),
                ('publicity', models.CharField(choices=[('private', 'Private'), ('public', 'Public')], default='private', max_length=50)),
